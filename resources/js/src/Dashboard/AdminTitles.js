...
class AdminTitles extends Component {
   ...
   componentDidMount(){
    ...
    loadUsers(){
    	this.props.adminUsersGet(adminTitlesQuery({first:this.state.first, page:this.state.page})) 
    }
...
const adminTitlesQuery = (variables)=>{
...
export default connect(mapStateToProps, mapDispatchToProps)(withStyles(useStyles)(AdminTitles))
