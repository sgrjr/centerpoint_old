...
const INITIAL_STATE = window.INITIAL_STATE? window.INITIAL_STATE:{viewer:null}

const initState = {
    pending: false,
    carts: INITIAL_STATE.viewer && INITIAL_STATE.viewer.vendor? INITIAL_STATE.viewer.vendor.carts:[],
    selectedTitle: false,
    selectedCart: false,
    selectedQuantity: 1,
    open: false,
