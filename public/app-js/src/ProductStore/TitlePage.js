...
import titlePageQuery from './titlePageQuery'
import titlePageQueryMin from './titlePageQueryMin'
...
class TitlePage extends Component{
    ...
    componentDidMount(){
      const { isbn } = this.props.match.params
       ...
       if(this.props.title === undefined || isbn !== this.props.title.ISBN ){
          this.props.titleGet(titlePageQueryMin({
            "page":1,
            "perPage":10,
            "isbn": isbn
          }))
    ...
    componentWillReceiveProps(newProps){
      ...
      if(isFirstRender){
        ...
        this.props.titleGet(titlePageQuery({
          "page":1,
          "perPage":10,
          "isbn": isbn
        }))
